        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardContent}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Text style={styles.cardDate} numberOfLines={1}>
                {item?.tripDetails?.startDate || 'N/A'} -{' '}
                {item?.tripDetails?.endDate || 'N/A'}
              </Text>
            </View>
          ...
          <View style={styles.moreContainer}>
            <TouchableOpacity
              ...
              <SVGS.MORE
                width={isTablet ? wp(2.5) : wp(6)}
                height={isTablet ? wp(2.5) : wp(6)}
              />
            </TouchableOpacity>
...
const styles = {
  ...
  cardLocation: {
    fontSize: isTablet ? hp(2.1) : hp(1.8),
    color: COLORS.darkgray1,
    fontFamily: fontFamily.FONTS.Medium,
  },
  cardTitle: {
    fontSize: isTablet ? hp(2.4) : hp(2.1),
  ...
  cardPrice: {
    fontSize: isTablet ? hp(2.2) : hp(1.9),
    fontFamily: fontFamily.FONTS.bold,
    color: COLORS.darkgray,
  },
  moreContainer: {
    alignItems: 'center',
    padding: isTablet ? wp(0.4) : wp(2),
  ...
  gradientIconContainer: {
    marginBottom: isTablet ? hp(1) : hp(0),
    width: isTablet ? wp(2.5) : wp(8), // Adjust as needed
    height: isTablet ? wp(2.5) : wp(8), // Adjust as needed
