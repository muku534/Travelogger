const ICONS = {
    ACTIVITIES_AI: require('../assets/icons/Activitiesai_icon.png'),
    ACTIVITY: require('../assets/icons/Activitiy_icon.png'),
    ACTIVITY_MARKER: require('../assets/icons/activity_marker.png'),
